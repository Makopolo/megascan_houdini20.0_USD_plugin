    ...
    def importAsset(self, assetData, importOptions, importParams):
        ...
        if not importOptions["UI"]["ImportOptions"]["EnableUSD"]:
            ...
            if importOptions["UI"]["ImportOptions"]["Renderer"] == "Redshift" :
                ...
                #nodeAddParam = hou.FloatParmTemplate("parm1", "Parameter 1", 3, default_value=[1, 1, 1])
            ...
            #print("material type "+  importOptions["UI"]["ImportOptions"]["Material"])
            ...
            # elif importOptions["UI"]["ImportOptions"]["Renderer"] == "Karma":
            #     mantraContainer = hou.node(importParams["materialPath"]).createNode("Principled Shader", node_name=importParams["assetName"], run_init_scripts=False)
            #     importParams["materialPath"] = mantraContainer.path()
            ...
            print("usdRenderer Type " + usdRendererType)
            ...
            if assetData["type"] == "surface" or assetData["type"] == "atlas" and not importOptions["UI"]["ImportOptions"]["UseAtlasSplitter"] or assetData["type"] == "brush":
                ...
                print(importParams["materialPath"])
                print(usdMaterials[usdRendererType])
            ...
            if usdRendererType == "Karma":
                ...
                print("curr what am I " + usdRendererType )
            ...
            if importOptions["UI"]["ImportOptions"]["USDmatLoop"]==True and usdRendererType == "Mantra":
                usdRendererType = "Karma"
                print("assetName " + importParams["assetName"])
                karmaContainer = hou.node(importParams["materialPath"]).createNode("subnet", node_name=importParams["assetName"])
                importParams["materialPath"] = karmaContainer.path()
                print(importParams["materialPath"])
                #print(usdMaterials[usdRendererType])
            ...
            if assetData["type"] == "surface" or assetData["type"] == "atlas" and not importOptions["UI"]["ImportOptions"]["UseAtlasSplitter"] or assetData["type"] == "brush":
                ...
                print(usdMaterialContainer.path())
